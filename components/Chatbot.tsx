          ...
          {open ? (
            ...
            <>
              ...
              <div style={{ position: "relative", flexShrink: 0 }}>
                <div style={{ width: 44, height: 44, borderRadius: "50%", overflow: "hidden", border: "2.5px solid rgba(249,115,22,0.5)", boxShadow: "0 3px 10px rgba(0,0,0,0.2)" }}>
                  <Image src="/assets/specialist.png" alt="Fibre specialist" width={44} height={44} style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center 25%" }}/>
                </div>
                <span style={{ position: "absolute", bottom: -1, right: -1, width: 12, height: 12, borderRadius: "50%", background: "#22C55E", border: "2px solid #fff", animation: "pulseDot 1.8s ease-out infinite" }}/>
              </div>
              ...
              <div style={{ textAlign: "left", lineHeight: 1 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 5, marginTop: 4 }}>
                  ...
                  <span style={{ fontSize: 11, color: "#5B6079", fontWeight: 500, fontFamily: "var(--font-sans)" }}>Replied in 5 mins</span>
                </div>
              </div>

              {/* WA icon */}
              <div style={{ marginLeft: 4, width: 32, height: 32, borderRadius: "50%", flexShrink: 0, background: "linear-gradient(180deg,#2ee36b,#1eb95a)", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 4px 10px rgba(37,211,102,0.35)" }}>
              ...
              {/* Pulse ring */}
              <span style={{ position: "absolute", inset: -4, borderRadius: 999, border: "2px solid rgba(37,211,102,0.40)", animation: "ripple 2.4s ease-out infinite", pointerEvents: "none" }}/>
            </>
          )}
        </button>
      </div>
